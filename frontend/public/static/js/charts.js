/**
 * Note that we're not initialising or calling the function, we'll call it in `App.tsx`
 * sequentially when we're sure the expected arguments and elements are available
 */

/*!
 * Charts - ICOCrypto v1.6.0 by Softnio.
 **/
// Below function will take App Info object and also return App Info object which will be available globally
var __CHART_INIT = function(a, t, o) {
    "use strict";
    var n = t(".chart-data"),
        e = t(".chart-data-s2"),
        s = t(".chart-data-3");
